...
_MovieResponse _$MovieResponseFromJson(Map<String, dynamic> json) =>
    _MovieResponse(
      dates: MovieDates.fromJson(json['dates'] as Map<String, dynamic>),
...
_MovieDates _$MovieDatesFromJson(Map<String, dynamic> json) => _MovieDates(
  maximum: json['maximum'] as String,
  minimum: json['minimum'] as String,
);

Map<String, dynamic> _$MovieDatesToJson(_MovieDates instance) =>
